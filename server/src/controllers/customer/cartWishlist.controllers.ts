...
const updateCustomerCartIncrease = asyncHandler(async (req, res, next) => {
  const dbuser = await getDbUserFromReq(req);
...
const updateCustomerCartDecrease = asyncHandler(async (req, res, next) => {});

const deleteCustomerCartWishlist = asyncHandler(async (req, res, next) => {});

const syncCustomerCartWishlist = asyncHandler(async (req, res, next) => {});

const getCustomerWishlist = asyncHandler(async (req, res, next) => {});
const postCustomerWishlist = asyncHandler(async (req, res, next) => {});
const deleteCustomerWishlist = asyncHandler(async (req, res, next) => {});
